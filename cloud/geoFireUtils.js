 ...
 */
module.exports.encodeGeohash = function encodeGeohash(location, precision) {
 ...
 */
module.exports.encodeGeoFireObject = function encodeGeoFireObject(location, geohash) {
  validateLocation(location);
  validateGeohash(geohash);
  return {
    ".priority": geohash,
